...
import NotificationMessageIndex from '../../src/components/notifications/NotificationMessageIndex'
...
test("Should create personal page",()=>{
    ...
    const reviewElement = screen.getByTestId('notification_message_index-1');
