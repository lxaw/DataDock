...
import NotificationReviewIndex from '../../src/components/notifications/NotificationReviewIndex'
...
test("Should create personal page",()=>{
    ...
    const reviewElement = screen.getByTestId('notification_review_index-1');
