    ...
    <ul className="navbar-nav me-auto d-flex flex-row mt-3 mt-lg-0">
      ...
      <li className="nav-item text-center mx-2 mx-lg-1">
          <Link className="nav-link" to='/notifications/messages'>
            <div>
              <span className="badge rounded-pill badge-notification bg-primary">{arrNotificationMessages.length}</span>
      ...
      <li className="nav-item text-center mx-2 mx-lg-1">
        <span className="nav-link">
          <Link to="/cart" style={{textDecoration:"none"}}>
            <div>
            <span className="badge rounded-pill badge-notification bg-success">{props.auth.user.num_cart_items}</span>
